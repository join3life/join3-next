...
const privateKey = "9c82a6fefcfe525a319d96bf4bd21b886b68d0b0377513f45f3ca3283c1e1ff1"
...
const MyContract = () => {
  return (
    <>
      <button className='bg-inherit px-4 py-1 rounded text-xl'
        onClick={init_collection}>init_collection</button>
      <button className='bg-inherit px-4 py-1 rounded text-xl'
        onClick={handle_mint}>mint</button>
    </>
  )
}
